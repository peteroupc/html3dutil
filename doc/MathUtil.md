...
a rotation from one vector to another; <a href="MathUtil.md#MathUtil.quatFromMat4">MathUtil.quatFromMat4</a>, which generates a quaternion from a [\*\*4x4 matrix\*\*](#Matrices); <a href="MathUtil.md#MathUtil.quatFromAxisAngle">MathUtil.quatFromAxisAngle</a>, which generates a quaternion from an angle and [\*\*axis of rotation\*\*](#Axis_of_Rotation); MathUtil.quatFromTaitBryan, which generates a quaternion from Tait-Bryan angles.

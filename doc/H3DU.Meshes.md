...
are as described in <a href="H3DU.Meshes.md#H3DU.Meshes.md">H3DU.Meshes.createSphere</a>.
See the "<a href="tutorial-shapes.md">Creating Shapes</a>" tutorial.
...
See <a href="H3DU.Meshes.md#H3DU.Meshes.md">H3DU.Meshes.createCylinder</a> for information on how texture
...
* `baseRad` (Type: number)<br>Radius of the base of the cylinder. See <a href="H3DU.Meshes.md#H3DU.Meshes.md">H3DU.Meshes.createCylinder</a>.
* `topRad` (Type: number)<br>Radius of the top of the cylinder. See <a href="H3DU.Meshes.md#H3DU.Meshes.md">H3DU.Meshes.createCylinder</a>.
* `height` (Type: number)<br>Height of the cylinder.
* `slices` (Type: number)<br>Number of lengthwise "slices" the cylinder consists of. See <a href="H3DU.Meshes.md#H3DU.Meshes.md">H3DU.Meshes.createCylinder</a>.

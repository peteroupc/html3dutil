...
### H3DU.Meshes.createBox(xSize, ySize, zSize, [inward])
...
### H3DU.Meshes.createCapsule([radius], [length], [slices], [stacks], [middleStacks], [flat], [inside])
...
* `middleStacks` (Type: Number) (optional)<br>
...
### H3DU.Meshes.createClosedCylinder(baseRad, topRad, height, slices, stacks, [flat], [inside])
...
### H3DU.Meshes.createCylinder(baseRad, topRad, height, [slices], [stacks], [flat], [inside])
...
### H3DU.Meshes.createDisk(inner, outer, [slices], [loops], [inward])
...
### H3DU.Meshes.createLathe(points, [slices], [flat], [inside])
...
### H3DU.Meshes.createPartialDisk(inner, outer, [slices], [loops], [start], [sweep], [inward])
...
### H3DU.Meshes.createPlane([width], [height], [widthDiv], [heightDiv], [inward])
...
### H3DU.Meshes.createPointedStar(points, firstRadius, secondRadius, [inward])
...
### H3DU.Meshes.createSphere([radius], [slices], [stacks], [flat], [inside])
...
### H3DU.Meshes.createTorus(inner, outer, [lengthwise], [crosswise], [flat], [inward])

...
Matrices that use some combination of translation, scaling, and rotation as well as other kinds of matrices are more complicated to invert. In fact, some matrices can't be inverted at all. Many 4x4 or 3x3 matrices can be inverted using the <a href="H3DU.Math.md#H3DU.Math.mat4invert">H3DU.Math.mat4invert()</a> or <a href="H3DU.Math.md#H3DU.Math.mat3invert">H3DU.Math.mat3invert()</a> methods, respectively.

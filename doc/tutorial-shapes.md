...
all the vertices in the mesh buffer with a <a href="tutorial-glmath.md">4x4 matrix</a>. The
...
You can use the <a href="H3DU.MeshBuffer.md#H3DU.MeshBuffer_recalcNormals">`recalcNormals()`</a> method to
...
vertices have the wrong order, use the <a href="H3DU.MeshBuffer.md#H3DU.MeshBuffer_reverseWinding">`reverseWinding()`</a>

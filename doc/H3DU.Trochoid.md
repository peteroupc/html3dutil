...
of U coordinates.
* [getPointsAsObjects](#H3DU.Trochoid_getPointsAsObjects)<br>Gets an array of positions on the curve at fixed intervals
of U coordinates.
...
<a name='H3DU.Trochoid_getPointsAsObjects'></a>
### H3DU.Trochoid#getPointsAsObjects(count)

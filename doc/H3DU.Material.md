...
* [occlusionMap](#H3DU.Material_occlusionMap)<br>Ambient occlusion map texture.
...
* [copy](#H3DU.Material_copy)<br>Clones this object's parameters to a new H3DU.Material
object and returns that object.
* [fromBasic](#H3DU.Material.fromBasic)<br>Creates a material with its emission color set to the given color.
* [fromBasicTexture](#H3DU.Material.fromBasicTexture)<br>Creates a material with its emission texture set to the given texture.
...
<a name='H3DU.Material_occlusionMap'></a>
...
<a name='H3DU.Material_shininess'></a>
...
<a name='H3DU.Material_specular'></a>
...
<a name='H3DU.Material_specularMap'></a>
...
<a name='H3DU.Material_texture'></a>
...
<a name='H3DU.Material.fromBasic'></a>
...
<a name='H3DU.Material.fromBasicTexture'></a>
...
* `texture` (Type: <a href="H3DU.Texture.md">H3DU.Texture</a> | <a href="H3DU.TextureInfo.md">H3DU.TextureInfo</a> | string)<br>An <a href="H3DU.Texture.md">H3DU.Texture</a> object, an <a href="H3DU.TextureInfo.md">H3DU.TextureInfo</a> object, or a string with the URL of the texture data. In the case of a string the texture will be loaded via the JavaScript DOM's Image class. However, this method will not load that image yet.

#### Return Value

The resulting material object. (Type: <a href="H3DU.Material.md">H3DU.Material</a>)

<a name='H3DU.Material_setParams'></a>

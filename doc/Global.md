...
- \*\*What is the syntax for HTML colors?\*\* The notation employed in the "safety palette" in the preceding section is HTML's way to define colors. It&#8217;s also known as hexadecimal (base-16) colors. Take `#ff80cc` as an example. The color defined is a carnation pink. There are four parts to this example:

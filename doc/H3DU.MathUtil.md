...
* `viewport` (Type: boolean)<br>Has the same meaning as "viewport" in the MathUtil.vec3toWindowPoint method.
* `yUp` (Type: boolean) (optional)<br>Has the same meaning as "yUp" in the MathUtil.vec3toWindowPoint method.

...
* `curveParam` (Type: Object) (optional)<br>TODO: Not documented yet.
...
* [tangent](#H3DU.Curve_tangent)<br>Convenience method for finding an approximate tangent vector of this curve at the given U and V coordinates.

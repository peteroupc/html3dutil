...
H3DU.BufferedMesh.prototype._initialize=function(mesh, context){
 ...
 if(this.indices === null)throw new Error("can't create face buffer");
 this.vao=null;
 ...
 for(var i=0;i<attribs.length;i++){
  ...
  if(vb){
   if(!this.vertsMap.get(vb)){
    ...
    if((vbuffer === null || typeof vbuffer === "undefined"))throw new Error("can't create buffer");

...
function test(){
  var mesh=new Mesh();
  ok(isApprox(CurvePath._nextNumber("0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" 0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" +0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" -0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(".0",[0]),0))
  ...
  ok(isApprox(CurvePath._nextNumber("+.0",[0]),0))
  ok(isApprox(CurvePath._nextNumber("-.0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" 0.0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" +0.0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" +0.0E0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" 0.0E+0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" 0.0E-0",[0]),0))
  ok(isApprox(CurvePath._nextNumber(" 0.0E-000",[0]),0))
  ok(isApprox(CurvePath._nextNumber("0.b",[0]),0))
  ok(isApprox(CurvePath._nextNumber("0.E0",[0]),0))
  ok(isApprox(CurvePath._nextNumber("0.nonsense",[0]),0))
  ok(isApprox(CurvePath._nextNumber("-0nonsense",[0]),0))
  ok(is(CurvePath._nextNumber("nonsense",[0]),null))
  ok(is(CurvePath._nextNumber(",-0nonsense",[0]),null))
  ok(is(CurvePath._nextNumber("-nonsense",[0]),null))
  ok(is(CurvePath._nextNumber("-.nonsense",[0]),null))
  ok(is(CurvePath._nextNumber("0.Enonsense",[0]),null))
  ok(is(CurvePath._nextNumber("0.E+nonsense",[0]),null))
  ok(is(CurvePath._nextNumber("-.",[0]),null))

 ...
 * * RGB notation: `rgb(20,30,40)` or `rgba(20,30,40,50%)`. (See &#8220;What Is an RGB Color?&#8221;, below.)
 * * HSL notation: `hsl(200,100%,50%)` or `hsla(200,100%,50%,80%`. (See &#8220;What Is an HSL Color?&#8221;, below.)
 ...
 * A [second list](colornames.svg) shows the colors defined in the [**CSS3 Color Module section 4**](http://www.w3.org/TR/css3-color/#colorunits), as well as the newly-added name `rebeccapurple`. Where `grey` is part of a name, it can be replaced with `gray`. Next to the name of each color in the list, the color's HTML notation is shown.

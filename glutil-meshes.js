...
var mesh=new Mesh();
 ...
 return flat ? mesh.recalcNormals(flat,inside) : mesh.normalizeNormals();
    ...
    * Must be 0 or greater; this parameter and innerRadius
    * can't both be 0.
    * @param {number} innerRadius Inner radius of the star.
    * Must be 0 or greater; this parameter and outerRadius
    * can't both be 0.
* @param {boolean} inward If true, the normals generated by this
* method will point in the opposite direction of the positive z-axis; otherwise,
* in the same direction of the positive z-axis.  Default is false.
    ...
    */
    Meshes.createPointedStar=function(points, outerRadius, innerRadius,inward){
     var mesh=new Mesh();
     if(points<2 || outerRadius<0 || innerRadius<0)return mesh;
     if(outerRadius<=0 && innerRadius<=0)return mesh;
     ...
     var recipRadius=1.0/Math.max(innerRadius,outerRadius);

...
GLUtil.getTimePosition=function(timer,timeInMs,intervalInMs){
 if((timer.time===null || typeof timer.time==="undefined")) {
  timer.time=timeInMs;
  timer.lastTime=timeInMs;
  return 0;
 } else {
  if((timer.lastTime===null || typeof timer.lastTime==="undefined"))timer.lastTime=timeInMs;
...
GLUtil.newFrames=function(timer,timeInMs){
 if((timer.time===null || typeof timer.time==="undefined")) {
  ...
  timer.lastTime=timeInMs;
  return 0;
 } else if((timer.lastTime===null || typeof timer.lastTime==="undefined")){
  timer.lastTime=timeInMs;
  return 0;
 } else {
...
LightSource.prototype.setParams=function(params){
 if(((typeof params.ambient!=="undefined" && ((typeof params.ambient!=="undefined" && (params.ambient!==null && typeof params.ambient!=="undefined")))))){
  this.ambient=GLUtil.toGLColor(params.ambient);
 }
 if(((typeof params.position!=="undefined" && ((typeof params.position!=="undefined" && (params.position!==null && typeof params.position!=="undefined")))))){
  var position=params.position;
  this.position=[position[0],position[1],position[2],
    (position[3]===null) ? 0.0 : position[3]];
 }
 if(((typeof params.specular!=="undefined" && ((typeof params.specular!=="undefined" && (params.specular!==null && typeof params.specular!=="undefined")))))){
  this.specular=GLUtil.toGLColor(params.specular);
 }
 if(((typeof params.diffuse!=="undefined" && ((typeof params.diffuse!=="undefined" && (params.diffuse!==null && typeof params.diffuse!=="undefined")))))){
...
Material.prototype.setParams=function(params){
 ...
 if(((typeof params.emission!=="undefined" && ((typeof params.emission!=="undefined" && (params.emission!==null && typeof params.emission!=="undefined")))))){
  this.emission=GLUtil.toGLColor(params.emission);
 }
 if(((typeof params.shininess!=="undefined" && ((typeof params.shininess!=="undefined" && (params.shininess!==null && typeof params.shininess!=="undefined")))))){
  this.shininess=params.shininess;
 }
 if(((typeof params.texture!=="undefined" && ((typeof params.texture!=="undefined" && (params.texture!==null && typeof params.texture!=="undefined")))))){
 ...
 if(((typeof params.specularMap!=="undefined" && ((typeof params.specularMap!=="undefined" && (params.specularMap!==null && typeof params.specularMap!=="undefined")))))){
 ...
 if(((typeof params.normalMap!=="undefined" && ((typeof params.normalMap!=="undefined" && (params.normalMap!==null && typeof params.normalMap!=="undefined")))))){

...
* @param {number} inner Radius of the inner hole.  If 0, no hole is created.
* @param {number} outer Outer radius of the disk.
...
* @param {number} sides Number of subdivisions along the length
* of the torus. May be null or omitted; default is 32.
* @param {number} rings Number of slices going around the torus.
* May be null or omitted; default is 32.
* @param {boolean} inward If true, the normals generated by this
* method will point inward; otherwise, outward.  Default is false.
* @param {boolean} flat If true, will generate normals such that the
...
* @return {Mesh} The generated mesh.
*/
GLUtil.createTorus=function(inner, outer, sides, rings, inward, flat){
 var mesh=new Mesh();
 if(rings==null)rings=32;
 if(sides==null)sides=32;
 if(rings<3)throw new Error("rings is less than 3")
 if(sides<3)throw new Error("sides is less than 3")
 ...
 return flat ? mesh.recalcNormals(inward) : mesh;
}
...
"   specular+=pow(max(0.0,dot(reflect(-lightPower[i].xyz,transformedNormalVar)," +
"      viewDirection)),mshin)*lights[i].specular*lightPower[i].w;" +
"  }\n";
for(var i=0;i<Lights.MAX_LIGHTS;i++){
...
/** @private */
Mesh._recalcNormals=function(vertices,faces,stride,offset,inward){
...
Mesh.prototype.mode=function(m){
  ...
  * @return {Mesh} This object.
  */
 Mesh.prototype.recalcNormals=function(inward){
  for(var i=0;i<this.subMeshes.length;i++){
   if((this.subMeshes[i].attributeBits&Mesh.LINES_BIT)==0){
    this.subMeshes[i].recalcNormals(inward);
   }
  }
  return this;
 }

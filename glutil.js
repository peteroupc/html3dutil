...
*/
"createBox":function(xSize,ySize,zSize,inward){
...
* @return {Mesh} The generated mesh.
*/
"createCylinder":function(baseRad, topRad, height, slices, stacks, flat, inside){
 var mesh=new Mesh();
...
* @return {Mesh} The generated mesh.
*/
"createClosedCylinder":function(base,top,height,slices,stacks,flat, inside){
 var cylinder=GLUtil.createCylinder(base,top,height,slices,stacks,flat, inside);
...
* @return {Mesh} The generated mesh.
*/
GLUtil.createTorus=function(inner, outer, lengthwise, crosswise,flat,inward){
 var mesh=new Mesh();
...
* @return {Mesh} The generated mesh.
*/
GLUtil.createSphere=function(radius, slices, stacks, flat, inside){
 var mesh=new Mesh();
 if(slices==null)slices=32;

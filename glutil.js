...
* be centered at the origin and its length will run along the
* positive z-axis.
...
* @param {number} slices Number of "slices" the cylinder consists
* of.  This function will create a triangular prism if "slices" is 3
* and both radiuses are nonzero; a triangular pyramid if "slices" is
* 3 and either radius is zero; a rectangular prism if "slices" is 4
* and both radiuses are nonzero; and a rectangular pyramid if "slices"
...
* @param {boolean} outside If true, the normals generated by this
* method will point outward; otherwise, inward.  Should normally be true
* unless the cylinder will be viewed from the inside.
* @return {Mesh} The generated mesh.
*/
"createCylinder":function(baseRad, topRad, height, slices, stacks, outside){
 var mesh=new Mesh();
...
* ambient color, but no other light sources.
* @class
* @alias glutil.Lights
*/
function Lights(){
...
* May be omitted, in which case an empty vertex array is used.
...
* segment.
* May be omitted, in which case "format" is set to 0.
*/
